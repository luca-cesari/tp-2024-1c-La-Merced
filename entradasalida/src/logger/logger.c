...
{
   log_info(io_logger, "PID: %d - Truncar Archivo: %s - Tamaño a Leer: %d - Puntero Archivo: %d", pid, nombre_archivo, tamanio, puntero_a_archivo);
}

void log_escribir_archivo(u_int32_t pid, char *nombre_archivo, u_int32_t tamanio, u_int32_t puntero_a_archivo)
{
   log_info(io_logger, "PID: %d - Truncar Archivo: %s - Tamaño a Escribir: %d - Puntero Archivo: %d", pid, nombre_archivo, tamanio, puntero_a_archivo);
}
